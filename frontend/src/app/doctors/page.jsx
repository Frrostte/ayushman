        ...
        <div className="text-foreground">
            <div className="flex flex-col sm:flex-row justify-between items-center mb-10 gap-6">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Manage doctor profiles and details.</p>
                </div>
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-gray-50 dark:bg-white/5 border-b border-gray-100 dark:border-white/5">
                                ...
                                <th className="px-6 py-4 text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Email</th>
                                <th className="px-6 py-4 text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Contact</th>
                                <th className="px-6 py-4 text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Joined Date</th>
                                <th className="px-6 py-4 text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Action</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-100 dark:divide-white/5">
                            {doctors.map(d => (
                                <tr key={d._id} className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                                    ...
                                    <td className="px-6 py-4">
                                        <Link
                                            href={`/doctors/${d._id}`}
                                            className="inline-flex items-center px-3.5 py-1.5 bg-white dark:bg-white/5 hover:bg-primary hover:dark:bg-primary/20 text-gray-700 dark:text-gray-300 hover:text-white dark:hover:text-primary-light text-xs font-bold rounded-lg transition-all border border-gray-200 dark:border-white/10 hover:border-primary dark:hover:border-primary/30 shadow-sm"
                                        >
                                            View Profile
                                        </Link>
                                    </td>
...

            {
                doctors.length === 0 && (
                    <div className="bg-white dark:bg-surface rounded-3xl border border-gray-100 dark:border-white/5 p-12 text-center shadow-xl mt-8">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 max-w-sm mx-auto mb-8">Get started by adding a new doctor to the system.</p>
                        <Button
